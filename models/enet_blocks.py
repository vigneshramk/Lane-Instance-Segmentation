...
class ENetUpsamplingBottleneck(nn.Module):
    ...
    def __init__(self,
        ...
        # Extension Branch
        # Step 1: 1x1 projection convolution with stride 1
        # to do dimensionality reduction
        self.conv1 = nn.Sequential(
                nn.Conv2d(
                in_channels, reduced_channels, 
                kernel_size=1, bias=bias),
                nn.BatchNorm2d(reduced_channels), activation)

        # Step 2: Transposed convolution on the reduced input channels
        ...
        # Step 3: 1x1 expansion convolution to convert to number of output channels
        self.conv3 = nn.Sequential(
                nn.Conv2d(
    ...
    def forward(self, x, max_indices):
        ...
        # Main branch doing padding (as spatial convolution) and
        # max unpooling
        main = self.padding_conv(x)
        main = self.maxunpool(main, max_indices)
